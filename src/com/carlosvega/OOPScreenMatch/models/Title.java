...
public class Title {
    ...
    public Title(TitleOmdb titleOmdb){
        ...
        this.minutesLenght = Integer.valueOf(titleOmdb.runtime()
                .substring(0,3) //substring para tranformar parte del string a int
                .replace(" ","")); //metodo para reemplazar valores de un string
    }
    //getters y setters
